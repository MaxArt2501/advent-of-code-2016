...
> P.S.: the name of the room we're looking for it's not explicitly mentioned in the problem. It's not your fault for not noticing it. You can either try to figure it out (grepping the results with the correct keywords), or peek at the last lines of my solution, where it's written in full.
